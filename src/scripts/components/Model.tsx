...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF(model) as GLTFResult
  const _scale = (innerWidth/innerHeight)*0.35;
  const [activeIndex, setActiveIndex] = useState(1);

  materials['Material.001'].envMapIntensity = 0.5;
  materials['Material.001'].sheen = 0.2;
  materials['Material.001'].sheenColor = new Color("#000000").convertSRGBToLinear();
  materials['Material.003'].color = new Color("#ffffff").convertSRGBToLinear();
  materials['Material.003'].emissiveIntensity = 0;
  materials['Material.004'].color = new Color("#d6d3d1").convertSRGBToLinear();
  materials['Material.004'].emissiveIntensity = 0;
  materials['Material.005'].color = new Color("#a8a29e").convertSRGBToLinear();
